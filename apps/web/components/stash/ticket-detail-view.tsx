...
import { useTicketMessages } from "@/lib/queries";
import { ActivityLogModal } from "./activity-log-modal";
import { EmojiProgressIcon } from "./emoji-progress-icon";
...
export function TicketDetailView({ ticket, onClose }: TicketDetailViewProps) {
  ...
  const { isCollapsed, setCollapsed } = useTicketsStore();
        ...
        <div className="flex flex-1 gap-6 px-6 py-4">
          ...
          <div className="nice-gray-border flex w-1/2 flex-col rounded-2xl border bg-white">
            ...
            <div className="border-b p-6">
              ...
              >
                <Copy className="size-4 scale-x-[-1] transform" />
                Copy Summary
              </Button>
            </div>
