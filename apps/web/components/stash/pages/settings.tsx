...
import { useSession, signIn } from "@ticketsbot/auth/client";
import { useState, useEffect } from "react";
import GeneralSettings from "@/components/settings/general-settings";
import TeamRoles from "@/components/settings/team-roles";
import Tickets from "@/components/settings/tickets";
import OpenCommands from "@/components/settings/open-commands";
import ContextMenu from "@/components/settings/context-menu";
import AutoClose from "@/components/settings/auto-close";
import { PermissionGuard } from "@/components/permission-guard";
import { PermissionFlags } from "@/contexts/permission-context";
