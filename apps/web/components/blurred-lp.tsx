...
export const BlurredLp = () => {
  return (
    <main className="pointer-events-none fixed inset-0 h-screen w-full overflow-hidden text-[#ffffff] blur-sm">
      <Header />
      <Hero />
...
function Header() {
  return (
    <header className="sticky top-0 z-10 bg-[linear-gradient(120deg,#0e121b_0%,#052249_60%)]">
  ...
  return (
    <section className="relative overflow-hidden" aria-labelledby="hero-heading">
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute inset-0 hidden bg-[linear-gradient(120deg,#0e121b_0%,#052249_60%)] lg:block" />
        <div className="absolute -right-32 top-0 hidden h-[700px] w-[700px] rounded-full bg-[radial-gradient(circle_at_center,#3f40e3_0%,#7e7ee1_20%,transparent_60%)] opacity-50 blur-2xl lg:block" />
        <div
          className="absolute inset-0 opacity-[0.06] mix-blend-overlay"
          style={{
            background:
              "repeating-linear-gradient(to right, rgba(225,228,234,0.12) 0px, rgba(225,228,234,0.12) 1px, transparent 1px, transparent 180px)",
          }}
          aria-hidden="true"
        />
      </div>
      <div className="relative mx-auto grid max-w-screen-2xl grid-cols-1 gap-12 px-4 py-16 md:grid-cols-2 md:py-24 lg:gap-64 lg:py-28">
        ...
        <div className="relative">
          <div className="pointer-events-none absolute -right-6 -top-2 hidden md:-right-10 xl:block">
            <div className="relative">
              <div
                className="absolute inset-0 -z-10 hidden blur-3xl lg:block"
                style={{
              ...
              <Image
                ...
                width={80}
                height={80}
                className="rotate-25 -translate-x-[400px]"
                priority
              />
              <Image
                src={"/big-icon.svg"}
                ...
                width={380}
                height={380}
                className="rotate-5 -translate-x-[120%] -translate-y-10"
                priority
              />
            </div>
          </div>
          ...
          > */}
          <div className="relative mx-auto grid max-w-[540px] gap-5 pt-40 md:pt-10">
